...
'''
	Script for test phase: Prediction and evaluation
'''
...
def main():
	...
	sm = SMOTE(random_state=2493)	## Default oversampling: ratio 1:1 for all classes
	...
	# Recording file
	file = dirname(realpath(sys.argv[0])) + "/results/test_results_all_models_all_features_SMOTE.txt"
	...
	# Fitting, testing and evaluating models
	print("Calculate accuracies and confusion matrices for models...")
	print("Fitting XGB...")
